...
local function Run()
    ...
    task.wait(0.05)
    getgenv().crocsshared={version="2.6.1",gamename=SafeServices.MarketplaceService:GetProductInfo(game.PlaceId).Name,issupported=false,playername=LocalPlayer.Name,playerid=LocalPlayer.UserId,isloaded=false,devnote="Made with 💖 by Gato"}
    s("Caching Stuff...")
